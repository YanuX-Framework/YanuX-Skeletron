    ...
    if (weight !== bmiState.weight || height !== bmiState.height || result !== bmiState.result) {
        ...
        if ((bmiState.result !== null && bmiState.result !== undefined)
            ...
            document.getElementById('result').classList.toggle(
                'underweight',
                bmiState.result < 18.5
            );
            document.getElementById('result').classList.toggle(
                'normal',
                bmiState.result >= 18.5 && bmiState.result < 25
            );
            document.getElementById('result').classList.toggle(
                'overweight',
                bmiState.result >= 25
            ...
            document.getElementById('result').classList.remove('underweight', 'normal', 'overweight');
...
async function updateResources() {
    ...
    coordinator.updateResources(resourceManagementElement);
}
